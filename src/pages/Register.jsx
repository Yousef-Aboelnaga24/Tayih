...
function Register() {
  ...
  return (
    <section className="min-h-screen bg-gray-50 py-32 flex items-center justify-center relative overflow-hidden">
      {/* Decorative elements */}
      <div className="absolute top-0 left-0 w-125 h-125 bg-primary/10 rounded-full blur-[100px] -translate-y-1/2 -translate-x-1/4 pointer-events-none"></div>
      <div className="absolute bottom-0 right-0 w-150 h-150 bg-primary-dark/5 rounded-full blur-[120px] translate-y-1/3 translate-x-1/3 pointer-events-none"></div>
